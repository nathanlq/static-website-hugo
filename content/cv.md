...
Etudiant en Master Machine Learning, je suis actuellement en alternance pour l'entreprise [DataKhi](https://datakhi.fr/) ou je m'occupe aujourd'hui principalement de la normalisation et de l'extrapolation des données et de leur organisation en base pour le projet [Tossée](https://tossee.fr/). Sur mon temps libre je m'ammuse avec mon homelab et j'enseigne le saxophone et le solfège en école de musique.
...
*2023 - 2025*
- Méthodes de reduction de dimension
- Modèles linéaires
...
*Université de Lille, Sciences et Technologies*  
*2017 - 2020*  
- Études théoriques des fondements et des bases des mathématiques en algèbre et en analyse
- Analyse numérique et analyse numérique matricielle 
...
- Cloud et DevOps : Écosystème Azure
...
**Configuration d'homelab**  
Auto-hébergement de service à but didactique.

**Harmonisation automatique de mélodie**  
