...
nathan.leclercq9@protonmail.com | [LinkedIn](https://www.linkedin.com/in/nathan-leclercq-51292014b/) | [GitHub](https://github.com/nathanlq) | [Blog](https://nathan.leclercq.spacesheep.ovh/) | [Download PDF](/pdf/cv_nathan_leclercq_en.pdf)
...
- Full infrastructure deployment: K3s, Airflow, Ansible (5 roles), private Docker registry
- Multi-tenant architecture with partitioning, idempotency and historical backfill
- ~22,000 lines of code · Stack: Airflow, K3s, Ansible, Docker, PostgreSQL, MinIO, Playwright, Pandas
...
- 28 independent models, advanced feature engineering (50+ features: weather, calendar, holidays, D-minus reservations, cyclical encoding)
- Custom loss function (Huber), confidence interval calibration, non-regression tests (Pearson >= 0.999)
...
- Architected a complete data ecosystem for an eco-friendly fashion aggregator (~15 sub-projects)
- Multi-brand scraping (Playwright, Scrapy, custom YAML rules engine, 20+ brands)
- Normalization pipeline, environmental impact calculation (Ecobalyse API), product embeddings
- Backend API (FastAPI, PostgreSQL/pgvector, semantic search, recommendation) — response time < 100ms
...
- [5 published technical articles](https://nathan.leclercq.spacesheep.ovh/posts/)

**Book Recommendation System** · 2023 - 2025
- Full data pipeline: scraping >100k books, embeddings (TF-IDF + CamemBERT), FastAPI API
- PostgreSQL/pgvector, MLflow, Vue.js interface
- [6 published technical articles](https://nathan.leclercq.spacesheep.ovh/posts/)
...
- [5 technical articles on the DataKhi blog](https://www.datakhi.fr/fr/blog) (2026)
- [14 technical articles on my personal blog](https://nathan.leclercq.spacesheep.ovh/posts/) (2024-2025)
